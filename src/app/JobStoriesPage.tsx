...
const STORIES = [
  ...
  { name: "Linda H.", service: "Waterproofing", loc: "Germantown, TN", date: "September 2025", duration: "2 days", result: "Exterior waterproofing membrane applied. French drain installed. Grading corrected.", quote: "The crew was on time every day, kept me informed of every step, and the basement has been dry through two major storms.", img: "https://images.unsplash.com/photo-1766497278321-dff63e463f72?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=900" },
  ...
  { name: "Diana P.", service: "Waterproofing", loc: "Jackson, MS", date: "April 2025", duration: "2 days", result: "Crawl space waterproofed, drainage corrected, and air quality system installed.", quote: "The inspector found water intrusion I didn't even know I had. Fixed it before it became a major problem. Grateful for the thoroughness.", img: "https://images.unsplash.com/photo-1766497278321-dff63e463f72?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixlib=rb-4.1.0&q=80&w=900" },
];
